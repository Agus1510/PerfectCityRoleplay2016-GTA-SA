        ...
        <tbody class="content" id="category_', $category['id'], '_boards">';		
			...
			echo '
				<tr class="tcat">
					...
					<td class="centertext">', $txt['posts'], '</td>
					<td class="centertext">', $txt['topics'], '</td>
					<td>', $txt['last_post'], '</td>
				</tr>';
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td class="icon windowbg2"', !empty($board['children']) ? ' rowspan="2"' : '', '>
				...
				if (!empty($board['children']))
				{
					...
					<tr id="board_', $board['id'], '_children">
						<td colspan="4" class="children windowbg2">
