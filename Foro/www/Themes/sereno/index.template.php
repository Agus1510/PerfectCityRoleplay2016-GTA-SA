...
/*	This template is, perhaps, the most important template in the theme. It
	...
	http://www.simplemachines.org/
        ...
        Sereno (Premium) theme by Mick idesign360.com
*/
...
<head>';
	...
	echo '
	<script type="text/javascript" src="', $settings['theme_url'], '/js/modernizr.custom.js"></script>
	...
	<div id="top-info">
		<div class="wrapper">';
	              ...
	              if (!empty($settings['tagline']))
                      echo'
                                <div id="tagline">' , $settings['tagline'], '</div>';
...
function template_body_below()
{
	...
	<div id="footer">
            <div class="wrapper">
		<ul class="reset">
			<li class="copyright">', theme_copyright(), ' | <strong>Sereno</strong> by Mick. G | <a id="button_xhtml" href="http://validator.w3.org/check?uri=referer" target="_blank" class="new_win" title="', $txt['valid_xhtml'], '"><span>', $txt['xhtml'], '</span></a> |
...
function template_html_below()
{
	...
	echo '
		...
		<script type="text/javascript" src="', $settings['theme_url'], '/js/classie.js"></script>
		<script type="text/javascript" src="', $settings['theme_url'], '/js/uisearch.js"></script>
